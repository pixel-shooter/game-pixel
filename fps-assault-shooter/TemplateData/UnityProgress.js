...
function UnityProgress(gameInstance, progress) {
    ...
    {
        gameInstance.textProgress.innerHTML = 'Opening "FPS Assault Shooter"' +' <img src="' + rootPath + '/gears.gif" class="spinner" />';
        gameInstance.progress.style.display = 'none';
    }
    else
    {
        gameInstance.textProgress.innerHTML = 'FPS Assault Shooter ' + Math.floor(progress * 100) + '%' + ' <img src="' + rootPath + '/gears.gif" class="spinner" />';
    }
